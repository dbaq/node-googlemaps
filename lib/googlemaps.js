...
exports.placesTextSearch = function(key, query, latitude, longitude, callback, radius, sensor, types, lang, name, rankby) {
...
exports.autocomplete = function(key, input, latitude, longitude, callback, radius, types) {
  ...
  return makeRequest('/maps/api/place/autocomplete/json', args, true, returnObjectFromJSON(callback));
};

exports.placeDetails = function(key, placeid, callback, sensor, lang) {
  var args = {
    key: key,
    placeid: placeid
  };
